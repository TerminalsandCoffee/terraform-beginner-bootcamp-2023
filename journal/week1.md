...
It is recommend to place modules in a 'modules' directory when locally developing modules but we are able to name it whatever we like. 

## Passing Input Variables
We can pass input cariables to our module.
The module has to declar the terraform variables in its own variables.tf
